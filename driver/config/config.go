...
func New(ctx context.Context, l *logrusx.Logger, stdOutOrErr io.Writer, opts ...configx.OptionModifier) (*Config, error) {
	return NewWithCustomSchema(ctx, []byte(embedx.ConfigSchema), l, stdOutOrErr, opts...)
}

func NewWithCustomSchema(ctx context.Context, schema []byte, l *logrusx.Logger, stdOutOrErr io.Writer, opts ...configx.OptionModifier) (*Config, error) {
	var c *Config
